...
@InputType()
class JobListingCreateNestedManyWithoutCompaniesInput {
...
export { JobListingCreateNestedManyWithoutCompaniesInput as JobListingCreateNestedManyWithoutCompaniesInput };
